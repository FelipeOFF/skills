---
name: design-advisor
description: Industry-specific UI/UX design recommendations before you build — 550+ rules, 50 color palettes, 30+ font pairings, layout patterns, and anti-pattern warnings. Use this whenever you are designing or reviewing a UI, picking colors or fonts, or want concrete, industry-aware design guidance with hex codes and real component examples.
---
...
2. Search relevant CSV data files in the skill's data/ directory
