...
description: Analyze projects on a self-hosted SonarQube, fetch issues for a project or pull request, and suggest automated fixes. Use this whenever the user mentions SonarQube, code-quality gates, static-analysis issues, or wants to triage and resolve Sonar findings. Originally built as an OpenClaw skill.
---
