---
name: ant-design
description: Front-end design skill for building React UIs with Ant Design (antd) — component patterns, layout, forms, tables, and theming and tokens via ConfigProvider.
---
